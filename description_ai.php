...
."\n"
."【文章の型（新ノウハウベース）】\n"
."- 1文目: 『こんな人におすすめ』が伝わるように、悩み/面倒/楽にしたい を含めつつ、読む人の状況が浮かぶように少し具体化する\n"
."- 2文目: 使い始めてからの変化を体験“風”で（例: 『〜しなくてよくなった』）＋気持ちの変化を一言添える（例: 気が楽、迷いが減った 等）\n"
